...
//                previousButton.setImage(image.withRenderingMode(.alwaysOriginal), for: .normal)
...
//                nextButton.setImage(image.withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    private func addSubViewConstraints() {
        monthYearStack.topAnchor.constraint(equalTo: self.topAnchor, constant: 30).isActive = true
        monthYearStack.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        monthYearStack.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.width - 140).isActive = true
        
        previousImageView.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 20).isActive = true
        ...
        nextImageView.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -20).isActive = true
        ...
        daysStack.topAnchor.constraint(equalTo: monthYearStack.bottomAnchor, constant: 20).isActive = true
        daysStack.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 20).isActive = true
        daysStack.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -20).isActive = true
        daysStack.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        collectionView.topAnchor.constraint(equalTo: daysStack.bottomAnchor, constant: 20).isActive = true
...
extension CalenderView: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("Selected Date: ", totalSquares[indexPath.row].date?.string())
...
fileprivate class CalenderCollectionViewCell: UICollectionViewCell {
    ...
    private func addSubViewConstraints() {
        ...
        roundedView.heightAnchor.constraint(equalToConstant: 40).isActive = true
        roundedView.widthAnchor.constraint(equalToConstant: 40).isActive = true
